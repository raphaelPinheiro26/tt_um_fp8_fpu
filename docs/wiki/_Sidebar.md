...
- [Simulation & Tests](Simulation-and-Tests)
- [Formal (SymbiYosys)](Verification-Formal)
- [UVM (pyuvm)](Verification-UVM)
- [DFT](Verification-DFT)

**Physical**
- [Results & Metrics](Results-and-Metrics)
- [Hardening](Hardening-and-Metrics)
- [Area Runbook](Area-Runbook)
- [Timing Study](Timing-Study)
- [Combinational Optimization](Combinational-Optimization)

**Using it**
- [RISC-V Integration](RISC-V-Integration)
